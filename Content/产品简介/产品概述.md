...
![logo](../../Resource/产品简介/产品概述/MySQL.png "logo")

### 简介
云数据库 MySQL（MySQL）是基于开源数据库 MySQL 专业打造的高性能分布式数据存储服务，让用户能够在云中更轻松地设置、操作和扩展关系数据库。
云数据库 MySQL 主要特点如下：
- 云存储服务，是平台提供的面向互联网应用的数据存储服务。
...
### 相关概念
[实例](https://cloud.tencent.com/document/product/236/17136)：上的 MySQL 数据库资源。
...
[控制台](https://console.cloud.tencent.com/cdb)：基于 Web 的用户界面。
...
使用云数据库 MySQL 审计功能，来完善事后审计与追溯机制，请参考 [数据审计](https://cloud.tencent.com/document/product/672/14403)。
...
编写代码调用 API 访问的产品和服务，请参考 [ API 文档](https://cloud.tencent.com/document/api)。
